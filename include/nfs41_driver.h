...
typedef struct _FILE_NFS41_QUERY_IDMAP_INFORMATION {
    ULONG OutputFormat;
} FILE_NFS41_QUERY_IDMAP_INFORMATION, *PFILE_NFS41_QUERY_IDMAP_INFORMATION;

#define FILE_NFS41_QUERY_IDMAP_FORMAT_CPV               1
#define FILE_NFS41_QUERY_IDMAP_FORMAT_PLAINTEXT         2
